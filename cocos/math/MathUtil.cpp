...
// can't find an equivalent of Android.mk '$(call import-module,android/cpufeatures)'
// for building without makefiles, so this header isn't available at the moment.
